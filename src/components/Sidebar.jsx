    ...
    <aside className="relative col-span-12 md:col-span-4 md:sticky md:top-0 md:h-screen overflow-hidden md:overflow-y-auto p-6 md:p-8 flex flex-col md:justify-between bg-background z-10 custom-scrollbar-sidebar">
      ...
      <div className="text-sm text-textSecondary mt-6 md:mt-8 text-center md:text-left">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-2 pt-4">
          <a href={data.profile.cvLinkEs} download target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto px-3 py-2 bg-accent text-background font-semibold rounded-lg hover:shadow-lg hover:shadow-accent/20 transition-all duration-300 inline-flex items-center justify-center gap-2 text-xs">
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>
            {data.profile.downloadCvEs}
          </a>
          <a href={data.profile.cvLinkEn} download target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto px-3 py-2 bg-transparent text-accent font-semibold rounded-lg border border-accent/50 hover:bg-accent/10 hover:border-accent transition-all duration-300 inline-flex items-center justify-center gap-2 text-xs">
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>
