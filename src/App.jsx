      ...
      <div className="grid grid-cols-12 max-w-6xl mx-auto">
        <aside className="col-span-12 md:col-span-4 sticky top-0 h-screen p-8 flex flex-col justify-between bg-background">
          ...
          <div className="text-sm text-textSecondary mt-10">
            ...
            <div className="pt-6">
              <a href={`${import.meta.env.BASE_URL}CV-Guillermo-Fernando-Farfan.pdf`} download className="px-4 py-2 bg-accent text-black font-semibold rounded hover:opacity-80 transition">Descargar CV</a>
            </div>
          </div>
        </aside>
